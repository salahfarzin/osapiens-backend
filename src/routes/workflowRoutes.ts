 ...
 *         description: Internal server error
 */
async function getWorkflowResults(
    dataSource: DataSource,
    req: Request,
    res: Response,
): Promise<void> {
...
export function createWorkflowRouter(dataSource: DataSource): Router {
    ...
    router.get('/:id/status', (req, res) => getWorkflowStatus(dataSource, req, res));
    router.get('/:id/results', (req, res) => getWorkflowResults(dataSource, req, res));
